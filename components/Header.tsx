...
const Header: React.FC = () => {
  return (
    <motion.header 
      ...
      className="bg-m3-light-surface-container-low/80 dark:bg-m3-dark-surface-container-low/80 backdrop-blur-xl p-4 border-b border-slate-500/10 dark:border-slate-500/20 shadow-sm sticky top-0 z-10 flex items-center justify-between"
    >
